                ...
                <div class="d-flex flex-column text-center">
                    ...
                    <div class="pt-5">
                        <div class="btn p-2 btn-lg shadow-none">
                            <a href="<?php echo site_url(); ?>dashboard/technician" class="text-white ">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card shadow-none">
                                            <div class="card-body">
                                                ...
                                                <h3 class="ml-3">Welcome, <?php echo $this->session->userdata('user'); ?> !</h3>
                                                <h5 class="ml-3">List Job Request :</h4>
