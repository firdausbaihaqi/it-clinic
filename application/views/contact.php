        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbar_main">
          <ul class="navbar-nav ml-auto align-items-lg-center">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbar_main_dropdown_1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shortcut</a>
            ...
            <li class="nav-item">
              <a href="sign-in.html" target="_blank" class="btn btn-sm bg-white d-none d-lg-inline-flex">Sign In</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="./index.html">Looking for a Job?</a>
            </li>
          </ul>
        </div>
      </div>
