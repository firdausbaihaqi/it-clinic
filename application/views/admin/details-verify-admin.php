        ...
        <div class="col-md-12">
            ...
            <div class="card w-50 shadow-lg mx-auto" style="width: 18rem;">
                    ...
                    <div class="col-sm-12 mt-5">
                        <div class="d-flex justify-content-center">
                            <object data="empty.png" type="image/png">
                                <img src="<?php echo base_url(); ?>data/profile/<?php echo $rows2->image; ?>" class="avatar avatar-lg mr-3">
                            </object>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p class="h6">Email :</p>
                    <p class="h6">Last Education :</p>
                    <p class="h6">Phone Number :</p>
                    <br><br>
                    <center>
                        <a href="#" class="btn btn-sm btn-success" data-toggle="modal">Accept</a>
                            <a href="#" class="btn btn-sm btn-info" data-toggle="modal">Back</a>
                            <a href="#" class="btn btn-sm btn-danger" data-toggle="modal">Decline</a>
                    </center>
                </div>
            </div>
