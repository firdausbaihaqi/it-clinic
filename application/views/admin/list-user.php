<body>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-hover table-cards align-items-center" id="technician">
                        ...
                        <tbody>
                            <?php foreach ($verified_account as $rows2) {
                                if ($rows2->status == 'technician') {
                            ?>
                                    <!-- iki pembates antar item -->
                                    <tr>
                                        <td>
                                            <img class="rounded-circle" src="<?php echo base_url(); ?>data/profile/<?php echo $rows2->image; ?>" alt="..." width="100px" height="100px" style="object-fit: cover">
                                        </td>
                                        <td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    $verified_account_details = $this->admin_model->get_verified_account_details($rows2->user, $rows2->status);
                                                    ?>
                                                    <?php foreach ($verified_account_details as $rows_technician_detail) {
                                                    ?>

                                                        <div class="d-flex justify-content-center mb-5">
                                                            <img class="rounded-circle" src="<?php echo base_url(); ?>data/profile/<?php echo $rows_technician_detail->image; ?>" alt="..." height="250px" width="250px" style="object-fit: cover">
                                                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-hover table-cards align-items-center" id="customer">
                        ...
                        <tbody>
                            <?php foreach ($verified_account as $rows3) {
                                if ($rows3->status == 'customer') {
                            ?>
                                    <!-- iki pembates antar item -->
                                    <tr>
                                        <td>
                                        <img class="rounded-circle" src="<?php echo base_url(); ?>data/profile/<?php echo $rows3->image; ?>" alt="..." width="100px" height="100px" style="object-fit: cover">
                                        </td>
                                        <td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <?php
                                                    $this->load->model('admin_model');
                                                    $verified_account_details = $this->admin_model->get_verified_account_details($rows3->user, $rows3->status);
                                                    ?>
                                                    <?php foreach ($verified_account_details as $rows_customer_detail) {
                                                    ?>

                                                        <div class="d-flex justify-content-center mb-5">
                                                            <img class="rounded-circle" src="<?php echo base_url(); ?>data/profile/<?php echo $rows_customer_detail->image; ?>" alt="<?php echo base_url(); ?>assets/img/empty.png" height="250px" width="250px" style="object-fit: cover">
                                                        </div>
    ...
    <!-- footer -->
    <footer class="pt-5 pb-3 mt-5 footer  footer-dark bg-tertiary">
        <div class="container">
            <div class="row">
